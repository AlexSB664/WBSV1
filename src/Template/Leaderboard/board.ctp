...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
		...
		href="<?= $this->Url->build(['controller' => 'leaderboard', 'action' => 'board', $leagues->slug, $seasons_slug, $competition->slug]); ?>"> 
		<?= $competition->slug ?>
	    </a>
            <?php endforeach ?>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
	    ...
	    <a class="nav-item nav-link active" 
		href="<?= $this->Url->build(['controller' => 'leaderboard', 'action' => 'board', $leagues->slug , $row->slug, 'all' ]); ?>"> 
	      <?= $row->slug ?>
	    </a>
            <?php endforeach ?>
            <a class="nav-item nav-link active" href="<?= $this->Url->build(['controller' => 'leaderboard', 'action' => 'board']); ?>">Otras Ligas</a>
