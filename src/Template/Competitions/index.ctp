		...
		<?php foreach ($competitions as $competition) : ?>
			<div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up" data-aos-delay="100">
				<a href="/eventos/<?= $competition->id; ?>">
					<img src="/img/<?= $competition->flyer; ?>" alt="<?= $competition->season->league->name ?> - <?= $competition->season->name ?> - <?= $competition->name ?>" class="img-fluid">
				</a>
				<div class="p-4 bg-white">
					<span class="d-block text-secondary small text-uppercase"><?= date("l, F jS, Y g:i a",$competition->date->toUnixString()) ?> </span>
