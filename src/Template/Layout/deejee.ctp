...
<head>
  ...
  <link rel="stylesheet" href="/css/coliseum.min.css">
  <meta charset="utf-8">
...
<body>
  <div class="site-wrap">
    <?php
    if (!($this->request->params['controller'] === 'Freestylers' && $this->request->params['action']  === 'discoveryTop')) {
      echo $this->element('header_deejee');
    } ?>
    <?= $this->fetch('content') ?>
